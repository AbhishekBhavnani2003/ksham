  ...
  return (
    ...
    <div className="container px-6 py-12 mx-auto">
        <div>
            ...
            <h1 className="mt-2 text-2xl font-semibold text-gray-800 md:text-3xl dark:text-white" style={{    margin: "0px"}}>Chat to our friendly team</h1>
        ...
        <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
            <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
                <div>
                    ...
                    <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">kshaminnovation@gmail.com</p>
                </div>
                ...
                <div>
                    ...
                    <p className="mt-2 text-sm text-blue-500 dark:text-blue-400"> 312 Eye Street, India</p>
                </div>
                ...
                <div>
                    ...
                    <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">  +91 9373124725</p>
                </div>
            </div>
            ...
            <div className="p-4 py-6 rounded-lg bg-gray-50 dark:bg-gray-800 md:p-8">
                <form>
                    ...
                    <button className="w-full px-6 py-3 mt-4 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-500 rounded-lg hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50" style={{backgroundColor:'#172554'}}>
                        Send message
                    </button>
                </form>
            </div>
